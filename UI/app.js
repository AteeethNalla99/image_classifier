            ...
            */
            ...
            if (match) {
                ...
                for(let personName in classDictionary) {
                    ...
                    // Adjust for 1-based indexing - subtract 1 to get 0-based array position
                    let probabilityScore = match.class_probability[index - 1];
                    let elementName = "#score_" + personName;
                    
                    console.log("Person:", personName);
                    console.log("Dictionary Index:", index);
                    console.log("Array Position:", index - 1);
                    console.log("Score:", probabilityScore);
                    console.log("Element ID:", elementName);
                    console.log("Element found:", $(elementName).length > 0);
